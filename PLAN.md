...
5. Add deterministic fixtures, Docker/local commands, backend/frontend/Playwright tests, run all locally available checks, and document any environment-only limitations.
